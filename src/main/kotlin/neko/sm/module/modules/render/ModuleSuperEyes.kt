package neko.sm.module.modules.render

import neko.sm.module.PluginModule
import neko.sm.module.modules.render.supereyes.nametags.NameTags
...
object ModuleSuperEyes : PluginModule(
    ...
    fun getRenderName(player: Player): String {
        val isHacker = SpecialModules.AntiCheat.isHacker(player)
                && SpecialModules.AntiCheat.isEnabled
